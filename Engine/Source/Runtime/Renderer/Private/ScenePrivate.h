...
public:
	...
	virtual void UpdateSceneCaptureContentsWithGBuffers(class USceneCaptureComponent2D* CaptureComponent, class FGBufferRequest* InOutGBufferRequest) override;

...
namespace UnrealBuildTool
{
	...
	class UEBuildTarget
	{
		...
		private void SetupGlobalEnvironment(UEToolChain ToolChain, CppCompileEnvironment GlobalCompileEnvironment, LinkEnvironment GlobalLinkEnvironment)
		{
			...
			// HACK: force disable RTTI for CARLA Apple Silicon builds
			GlobalCompileEnvironment.bUseRTTI = (Platform == UnrealTargetPlatform.Mac) ? false : Rules.bForceEnableRTTI;

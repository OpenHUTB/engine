...
struct FBXImportOptions
{
	...
	*/
	...
	// true if meshes needs to be converted as relative to the center of a tile of 2x2 km (CARLA)
	bool bForceVerticesRelativeToTile;
	int32 TileSize;
...
protected:
	...
	*/
	...
	bool BuildStaticMeshFromGeometry(FbxNode* Node, UStaticMesh* StaticMesh, TArray<FFbxMaterial>& MeshMaterials, int LODIndex,
									 ...
									 bool bConvertToRelativeTile=false, int32 TileCenterx=0, int32 TileCentery=0);
...
private:
	...
	/**
	 * Write the center of the tile (0,0) in world coordinates in a file
	 */
	void WriteGridTileStartInfo(FString BasePath, int32 Centerx, int32 Centery, int32 TileSize);
};

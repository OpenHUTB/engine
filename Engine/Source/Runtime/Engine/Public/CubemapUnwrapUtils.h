...
{
    /**
    * Specifies fisheye parameters to be passed to shader
    * @param	DistortionCoeffs    D3,D5,D7,D9 distortion coefficients
    * @param	CameraMatrix        Fx,Fy,Cx,Cy
    * @param	ImageSize           Outputsize of the image
    * @param	MaxAngle            Maximum rendered fisheye angle.
    */
...
public:
    ...
    //           DistortionCoeffs << CameraMatrix << ImageSize << MaxAngle;
    //     return bShaderHasOutdatedParameters;
    // }

...
/** Custom flag for tagged components. */
SHOWFLAG_ALWAYS_ACCESSIBLE(NotDrawTaggedComponents, SFG_Normal, NSLOCTEXT("UnrealEd", "NotDrawTaggedComponentsSF", "NotDrawTaggedComponents"))

...
/**
 * Vehicle-specific anti roll bar setup
 */
USTRUCT()
struct PHYSXVEHICLES_API FAntiRollBarSetup
{
  GENERATED_USTRUCT_BODY()

  UPROPERTY(EditAnywhere, Category = AntiRollBarSetup)
  int32 Wheel0;
...
public:
	...
	/** Anti Roll Bar to create */
	UPROPERTY(EditAnywhere, Category = VehicleSetup)
	TArray<FAntiRollBarSetup> AntiRollBarSetups;

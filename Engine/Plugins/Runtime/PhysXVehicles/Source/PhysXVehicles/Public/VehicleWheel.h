...
class PHYSXVEHICLES_API UVehicleWheel : public UObject
{
	...
	/** Traveling direction of the suspsension */
	UPROPERTY(EditAnywhere, Category=Suspension)
	...
	/** Camber angle of wheel when at rest */
	UPROPERTY(EditAnywhere, Category = Camber)
	float 											CamberAngleAtRest;
	/** Camber angle of wheel when at max suspension droop*/
	UPROPERTY(EditAnywhere, Category = Camber)
	float 											CamberAngleAtMaxDroop;
	/** Camber angle of wheel when at max suspension compression */
	UPROPERTY(EditAnywhere, Category = Camber)

...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FVulkanCommandListContext::RHICopyToResolveTarget);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FVulkanDynamicRHI::RHIReadSurfaceData);
	...
	{
		TRACE_CPUPROFILER_EVENT_SCOPE("AcquireTexture_NoCPUReadBack");
		...
		{
			TRACE_CPUPROFILER_EVENT_SCOPE("VulkanRHI::vkCmdPipelineBarrier");
	...
	{
		TRACE_CPUPROFILER_EVENT_SCOPE("AcquireTexture_CPUReadBack");
	...
	{
		TRACE_CPUPROFILER_EVENT_SCOPE("TArrayOutputResize");
	...
	{
		TRACE_CPUPROFILER_EVENT_SCOPE("ConvertRawTextureToFColor");
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FVulkanDynamicRHI::RHIReadSurfaceFloatData);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FVulkanDynamicRHI::RHIRead3DSurfaceFloatData);
